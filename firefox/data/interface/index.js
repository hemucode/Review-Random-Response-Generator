...
const details = {
  "WEBSTORE": browser.runtime == undefined ? "" : `https://addons.mozilla.org/en-US/firefox/addon/review-response-generator/`,
  "HOMEPAGE": browser.runtime == undefined ? "https://www.downloadhub.cloud/2024/10/RandomReviewResponseGenerator.html" : browser.runtime.getManifest().homepage_url,
...
const settingsload = async() =>{
  ...
  $("#label0").innerText = browser.i18n == null ? "Generated: " + generated : 
  browser.i18n.getMessage("generated")+": "+generated;
  ...
  $("#label1").innerText = browser.i18n == null ? "Total Likes: " + like_no : 
      browser.i18n.getMessage("total_likes")+": "+like_no;

  $("#label2").innerText = browser.i18n == null ? "Total DisLikes: " + dislike_no : 
      browser.i18n.getMessage("total_dislikes")+": "+dislike_no;
...
const styleSheets = async() => {
    ...
    let str = browser.i18n == null ? "Generate Response" : browser.i18n.getMessage("generate_response");
...
const info = async() =>{
  ...
  $("#save").addEventListener("click", async() => {
     ...
     browser.storage != undefined ? await browser.storage.local.set({ additional }) : null;
  ...
  $("#review-text").placeholder = browser.i18n == null ? 
  "Additional response for the Review Response[contact us/ product or service information]":
  browser.i18n.getMessage("additional_response_place");
  ...
  $("#box1").addEventListener("change", async (event) => {
    ...
    browser.storage != undefined ? await browser.storage.local.set({ box1 }) : null;
    localStorage.box1 = box1;
  });

  $("#box2").addEventListener("change", async (event) => {
    const box2 = event.currentTarget.checked;
    browser.storage != undefined ? await browser.storage.local.set({ box2 }) : null;
  ...
  $("#color1").addEventListener("change", async (event) => {
    ...
    browser.storage != undefined ? await browser.storage.local.set({ top_color }) : null;
    $("#color1").value = top_color;
    styleSheets();
  });
  ...
  $("#color2").addEventListener("change", async (event) => {
    ...
    browser.storage != undefined ? await browser.storage.local.set({ buttom_color }) : null;
  ...
  $("#label1_del").addEventListener("click", () => {
    ...
    $("#label1").innerText = browser.i18n == null ? "Total Likes: 0": browser.i18n.getMessage("total_likes")+": 0";
  });
  ...
  $("#label2_del").addEventListener("click", () => {
    ...
    $("#label2").innerText = browser.i18n == null ? "Total DisLikes: " + 0 : browser.i18n.getMessage("total_dislikes")+": 0";
  });
  ...
  $("#label0_del").addEventListener("click", async () => {
    ...
    $("#label0").innerText = browser.i18n == null ? "Generated: " + generated : 
    browser.i18n.getMessage("generated")+": "+generated;
    browser.storage != undefined ? await browser.storage.local.set({ generated }) : null;
    localStorage.generated = generated;
  });

  $("#language").addEventListener("change", async (event) => {
    const languges = event.currentTarget.value;
    browser.storage != undefined ? await browser.storage.local.set({ languges }) : null;
    localStorage.languges = languges;
  });


  copyResponse();
  browser.i18n ? translate() : null;
  linkAdd();
  disabledInspect();
...
const generatedBtn = async(reviewerName, productName) => {
    reviewerName.value=="" ? (alert(browser.i18n == null ? "Please Enter Reviewer Name" : browser.i18n.getMessage("reviewer_name_error"))) : 
    rating()== 0 ? (alert(browser.i18n == null ? "Select the ratings of the review received." : browser.i18n.getMessage("rating_description"))) :
